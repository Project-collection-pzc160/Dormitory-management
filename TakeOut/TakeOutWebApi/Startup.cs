...
namespace DormManagementApi
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContextPool<TakeOutOrderContext>(options => options
               // 连接字符串"TakeOutDatabase" 可以在appsetting.json中设置
               .UseMySql(Configuration.GetConnectionString("TakeOutDatabase"),
